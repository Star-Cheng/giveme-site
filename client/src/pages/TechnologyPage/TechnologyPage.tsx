    ...
    <div className="pt-28">
      ...
      <section className="pb-16">
        <div className="max-w-[1440px] mx-auto px-6 lg:px-10">
          <p className="text-xs text-[#2563eb] font-medium tracking-wider uppercase mb-4">核心技术</p>
      ...
      {[
        {
          title: "疾", en: "Ultra Speed", color: "text-[#2563eb]", bg: "bg-[#eff6ff]",
        ...
        {
          title: "智能", en: "Intelligent", color: "text-[#2563eb]", bg: "bg-[#eff6ff]",
